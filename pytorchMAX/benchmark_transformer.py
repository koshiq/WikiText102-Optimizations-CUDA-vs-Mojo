...
from model_max import TransformerModelMAX, max_matmul, max_log_softmax, max_layer_norm
...
def run_transformer_benchmark(config):
    ...
    # Copy weights from PyTorch model for fair comparison
    print("Copying weights from PyTorch model...")
    max_model.input_emb.weight.data = pytorch_model.input_emb.weight.data.clone()
