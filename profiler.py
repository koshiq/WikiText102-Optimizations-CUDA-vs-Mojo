...
# The --accel flag is kept for consistency but is no longer strictly necessary for CUDA.
if (args.accel or torch.cuda.is_available()) and torch.cuda.is_available():
